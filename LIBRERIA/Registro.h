...
get_di
@param 
@return int que representa el día inicial
*/
int Registro::get_di(){
    return di;
}
...
get_mi
@param 
@return int que representa el mes inicial
*/
int Registro::get_mi(){
    return mi;
}
...
get_ai
@param 
@return int que representa el año inicial
*/
int Registro::get_ai(){
    return ai;
}
...
get_df
@param 
@return int que representa el día final
*/
int Registro::get_df(){
    return df;
}
...
get_mf
@param 
@return int que representa el mes final
*/
int Registro::get_mf(){
    return mf;
}
...
get_af
@param 
@return int que representa el año final
*/
int Registro::get_af(){
    return af;
}
...
get_id_objeto
@param 
@return int que representa el id del objeto
*/
...
get_estatus
@param 
@return bool que representa el estatus
*/
...
/*
set_di
@param int que representa el día inicial
@return 
*/
...
/*
set_mi
@param int que representa el mes inicial
@return 
*/
...
/*
set_ai
@param int que representa el año inicial
@return 
*/
...
/*
set_df
@param int que representa el día final
@return 
*/
...
/*
set_mf
@param int que representa el mes final
@return 
*/
...
/*
set_af
@param int que representa el año final
@return 
*/
...
/*
set_estatus
@param bool que representa el estatus
@return 
*/
