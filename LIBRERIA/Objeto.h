...
get_id
@param 
@return int que representa el id
*/
int Objeto::get_id(){
    return id;
}
...
get_titulo
@param 
@return string que representa el titulo
*/
...
get_estado
@param 
@return bool que representa el estado (disponible o no)
*/
...
/*
set_id
@param int que representa el id
@return 
*/
...
/*
set_titulo
@param string que representa el titulo
@return 
*/
...
/*
set_estado
@param bool que representa el estado (disponible o no)
@return 
*/
