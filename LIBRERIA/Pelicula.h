...
get_formato
@param 
@return string que representa el formato (DVD o BD)
*/
...
get_productora
@param 
@return string que representa a la productora
*/
...
get_duracion_min
@param 
@return int que representa la duración en minutos
*/
...
/*
set_formato
@param string que representa el formato (DVD o BD)
@return 
*/
...
/*
set_productora
@param string que representa a la productora
@return 
*/
...
/*
set_duracion_min
@param int que representa la duración en minutos
@return 
*/
