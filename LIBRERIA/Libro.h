...
get_autor
@param 
@return string que representa al autor
*/
...
get_cant_pag
@param 
@return int que representa la cantidad de páginas
*/
...
/*
set_autor
@param string que representa el autor
@return
*/
...
/*
set_cant_pag
@param int que representa la cantidad de páginas
@return
*/
